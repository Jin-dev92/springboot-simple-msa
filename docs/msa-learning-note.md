...
이 절의 대가 역시 15절의 문장으로 모입니다. 조정자는 **나누었기 때문에 흩어진 흐름**을 다시 한 곳으로 모으려고 존재합니다.
...
| Outbox 를 참여자까지 확대 | order-service 에만 적용했다(13절). product·payment 는 리스너에서 직접 발행한다 | 참여자 응답도 유실되면 안 될 때 |
